...
public class Main {
    ...
    static void simulate() {
        ...
        /*System.out.printf("time: %d: shark(%d, %d), size: %d\n", time, babyShark.y, babyShark.x, babyShark.size);
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++) {
    ...
    static Fish bfs() {
        ...
        while (!queue.isEmpty()) {
            ...
            // System.out.printf("  y: %d, x: %d, grid[y][x]: %d\n",y, x, grid[y][x]);
            ...
            for (int d = 0; d < 4; d++) {
                ...
                if (isValidCoordinate(ny, nx) && visited[ny][nx] == 0 && grid[ny][nx] <= babyShark.size) {
                    ...
                    // System.out.printf("      ny: %d, nx: %d, visited[ny][nx]: %d\n", ny, nx, visited[ny][nx]);
                }
            }
        }
